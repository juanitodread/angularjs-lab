angular.module('maintenance')
  ...
  .constant("userId", "abb8b4c6-6dc2-40e6-b54d-30ae4300e026")
  .constant("userSecret", "ea7e529a45694fd09c85ef8fcbcdacc3dc025e1be439432e93194c712b0f988a4ef8a7b68af04c53bd8165096030750e");
...
function LocationsCtrl($scope, locationsApi) {
  ...
  function startEdit(id) {
    ...
    selectedId = id;
    editFlag = true;
    for(var location in $scope.locations.length) {
      if($scope.locations[location].id == id) {
        $scope.model.locationBox = $scope.locations[location].displayName;
      }
    }
  }
  ...
  function refresh() {
    busy(-2);
    locationsApi.getLocations().success(function (data) {
